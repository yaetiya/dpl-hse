...
export const MAX_PORT_COUNT = 2;
export const FONT_FAMILY = "realist, Helvetica, Arial, sans-serif";
export const OUT_PORT_HEIGHT = 28;
export const OUT_PORT_WIDTH = 78;
export const OUT_PORT_LABEL = "дальше";
export const ERROR_PORT_LABEL = "ошибка";
...
export const STENCIL_WIDTH = 300;
...
export const CONFIRMATION_ICON =
